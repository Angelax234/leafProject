...
function Page3({ onPrevious }) {
  ...
  return (
    <Icon name={checked ? 'check-square-o' : 'square-o'} size={24} color="black" />
      );
    };
    ...
    <View style={styles.page}>
      ...
      <View style={styles.checkboxContainer}>
        <View style={styles.checkboxItem}>
          {renderCheckbox(checkbox1)}
          <Text style={styles.checkboxText}>Task 1</Text>
          <Button title={checkbox1 ? 'Uncheck' : 'Check'} onPress={() => setCheckbox1(!checkbox1)} />
        </View>
        <View style={styles.checkboxItem}>
          {renderCheckbox(checkbox2)}
          <Text style={styles.checkboxText}>Task 2</Text>
          <Button title={checkbox2 ? 'Uncheck' : 'Check'} onPress={() => setCheckbox2(!checkbox2)} />
        </View>
        <View style={styles.checkboxItem}>
          {renderCheckbox(checkbox3)}
          <Text style={styles.checkboxText}>Task 3</Text>
          <Button title={checkbox3 ? 'Uncheck' : 'Check'} onPress={() => setCheckbox3(!checkbox3)} />
        </View>
      </View>
      <Button title="Previous Page" onPress={onPrevious} />
    </View>
